        	...
        	echo '<div class="span12">';
        		...
        		echo '<ul class="footer_social_icons">';
                    ...
                    foreach($social_icons as $icon):
        				...
        				echo '<li class="'.$icon['social'].'"><a target="_blank" href="'.$icon['link'].'"><i class="moon-'.$icon['social'].'"></i></a></li>';
...
class ContactInfoWidget extends WP_Widget{
    ...
    function widget($atts, $instance){
        ...
        echo '<ul>';
            ...
            if(!empty($address))
                echo '<li class="address"><span>'.__('Address:', 'themeple').'</span> <span>'.$address.'</span></li>';
            if(!empty($email))
                echo '<li class="email"><span>'.__('Email:', 'themeple').'</span> <span>'.$email.'</span></li>';
        	if(!empty($phone))
        		echo '<li class="phone"><span>'.__('Phone:', 'themeple').'</span> <span>'.$phone.'</span></li>';
            
            if(!empty($web))
                echo '<li class="web"><span>'.__('Web:', 'themeple').'</span> <span>'.$web.'</span></li>';
    ...
    function form($instance){
        ...
        $instance = wp_parse_args( (array) $instance, array('title' => '', 'address' => '', 'phone' => '', 'email' => '', 'web' => '') );
        ...
        $email = isset($instance['web']) ? $instance['web']: "";
        ...
        <p>
            ...
            <label for="<?php echo esc_attr($this->get_field_id('web')); ?>">Web

            <input id="<?php echo esc_attr($this->get_field_id('web')); ?>" name="<?php echo esc_attr( $this->get_field_name('web')); ?>" type="text" value="<?php echo esc_attr($web); ?>" /></label>
