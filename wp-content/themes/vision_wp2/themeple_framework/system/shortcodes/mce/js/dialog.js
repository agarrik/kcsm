...
var scnDialogHelper = {
    ...
    loadShortcodeDetails: function () {
        ...
        if (scnSelectedShortcodeType) {
            var a = this;
            jQuery.getScript(themeple_global.frameworkUrl + "system/shortcodes/sc/" + scnSelectedShortcodeType + ".js", function () {
                a.initializeDialog()
            })
        }
    },
    ...
    getTableKeyValue: function (a) {
    	...
    	var table_data = a.parents('#TB_window:eq(0)').find('#top .themeple_table');
    ...
    previewAction: function (a) {
        ...
        jQuery("#scn-preview-iframe").attr("src", themeple_global.frameworkUrl + "system/shortcodes/preview-shortcode-external.php?shortcode=" + encodeURIComponent(this.makeShortcode()))
    },
