...
$import_filepath = get_template_directory()."/template_inc/admin/dummy_data".$nr;
$errors = false;
...
if($errors){
   ...
   echo "Errors while loading classes. Please use the standart wordpress importer."; 
...

	{
		...
		echo $nr."Problem with dummy data file. Please check the permisions of the xml file";
