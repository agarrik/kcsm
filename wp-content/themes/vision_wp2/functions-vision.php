...
if(!function_exists('themeple_frontend_js'))
{
	...
	{	wp_register_script( 'jquery-easing-1-1', THEMEPLE_BASE_URL.'js/jquery.easing.1.1.js', array('jquery'), 1, true );
        ...
        wp_register_script( 'main', THEMEPLE_BASE_URL.'js/main.js', array('jquery', 'jquery.cookie'), 1, true);
        ...
        wp_register_script( 'post-like',THEMEPLE_BASE_URL.'js/post-like.js', array('jquery'), 1, true  );
