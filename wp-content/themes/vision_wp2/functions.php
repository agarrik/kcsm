...
function themeple_theme_setup(){
    ...
    add_image_size( 'port3', 634, 458, true );
    add_image_size( 'port2', 792, 600, true );
    add_image_size( 'port4', 514, 360, true );
    add_image_size( 'port_v2', 600, 600, true);
    add_image_size( 'recent_news', 155, 103, true);
    add_image_size( 'featured_blog', 520, 380,  true );
    add_image_size( 'blog', 1100, 600, true );
...
function themeple_register_scripts(){
    ...
    wp_enqueue_script('idangerous.swiper.min');
...
/* ---Post Like Load -----*/
require_once 'template_inc/post-like.php';
require_once 'functions-vision.php'; 
