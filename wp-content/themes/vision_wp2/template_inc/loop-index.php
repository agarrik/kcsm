...
if (have_posts()) :
	...
	while (have_posts()) : the_post();
        ...
        <article id="post-<?php echo the_ID(); ?>" <?php echo post_class('blog-article '.$extra_cl.' v1 normal'); ?>>                    
                    ...
                    <?php }elseif($post_format == 'gallery'){ ?>
                        ...
                        <?php $slider = new themeple_slideshow(get_the_ID(), 'flexslider');
                            ...
                            <div class="quote_box">
                                    ...
                                    <span class="author"><a href="<?php echo get_the_permalink(); ?>"><?php the_title(); ?></a></span>
                                    <span title="Quote" class="icon"></span>
                             </div>        
                             <?php if(!is_single()){ ?>
                             <div class="information">
                                <li><i class="linecon-icon-user"></i><?php _e('By', 'themeple') ?> <?php echo get_the_author() ?>&nbsp;  <i class="linecon-icon-bubble"></i> <?php echo esc_attr($count) ?> <?php _e('Comments', 'themeple') ?>&nbsp; <span class="post-like"><?php echo getPostLikeLink( get_the_ID() ); ?></span></li>
               ...
               <div class="date">On <?php the_time('F j, Y'); ?></div>
                    ...
                    <div class="blog-content">        
                                    ...
                                    <div class="information">
                                        ...
                                        <li><i class="linecon-icon-user"></i><?php _e('By', 'themeple') ?> <?php echo get_the_author() ?>&nbsp;  <i class="linecon-icon-bubble"></i> <?php echo esc_attr($count) ?> <?php _e('Comments', 'themeple') ?>&nbsp; 
                                        
                                        <?php if(themeple_get_option('like_bool')=='yes'){?>
                                        <span class="post-like"><?php echo getPostLikeLink( get_the_ID() ); ?></span></li>
                                        <?php } ?>
                            
                     <?php if(themeple_get_option('meta_bool')=='yes'){ ?>  
                     <li class="tags "><i class="linecon-icon-tag"></i><?php echo esc_attr($tag_out) ?></li>    
                        <?php  } ?> 
                        </div>
                        <?php if(themeple_get_option('sharing_bool')=='yes'){?>
                         <ul class="shares">
                                    ...
                                    <?php $social_icons = themeple_get_option('social_icons'); ?>       
                                        <?php $i = 0; if(!empty($social_icons))  foreach($social_icons as $icon): if(isset($icon['social']) && $icon['sharebutton'] == 'yes' ): $i++; ?>
                                            ...
                                            <?php    $link_shares = ${$icon['social'].'_shares'}; ?>
                                                ...
                                                <li class="<?php echo esc_attr($icon['social']) ?>"><?php echo $link_shares; ?><i class="moon-<?php echo esc_attr($icon['social']) ?>"></i></a></li>
                            ...
                            <span class="post-like"><?php echo getPostLikeLink( get_the_ID() ); ?></span></li> 
                                    ...
                                    <li></li> 
                                    <a class="btn-system normal pull-right readm" href="<?php echo get_permalink() ?>" class="readm"><?php _e('View More', 'themeple') ?></a>
                                </ul>
                            <?php endif; ?>
             ...
             <?php if(!is_single() && $post_format != 'quote' ): ?>    
<div class="divider-second-type"></div>
