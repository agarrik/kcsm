...
function themeple_register_sidebars(){
    ...
    register_sidebar(array(
      ...
      register_sidebar(array(
            'name' => __('Bottom Header - Vertical Widgetized', 'themeple'),
            'id' => 'Bottom Header - Vertical Widgetized',
            'before_widget' => '<div id="%1$s" class="widget %2$s">', 
    		'after_widget' => '</div>', 
    		'before_title' => '', 
    		'after_title' => ''
    ...
    register_sidebar(array(
            ...
            'id' => 'Copyright Footer Sidebar Left',
            'before_widget' => '<div id="%1$s" class="widget %2$s">', 
    		'after_widget' => '</div>', 
    		'before_title' => '', 
    		'after_title' => ''
    ...
    register_sidebar(array(
            ...
            'id' => 'Copyright Footer Sidebar Right',
            'before_widget' => '<div id="%1$s" class="widget %2$s">', 
    		'after_widget' => '</div>', 
    		'before_title' => '', 
    		'after_title' => ''
			...
			if(isset($name_array))
			{
	            foreach($name_array as $name){
					...
					register_sidebar(array(
	    				...
	    				'id' => 'Dynamic Template: Widget '.$name,
