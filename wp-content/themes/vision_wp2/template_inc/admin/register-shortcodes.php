...
if(!function_exists('themeple_sc_button')){
    ...
    function themeple_sc_button($atts, $content=null, $shortcodename =""){
        ...
        extract(shortcode_atts(array('icon' => '', 'type' => '', 'link' => '', 'onclick' => '', 'color' => '', 'size' => '', 'icon_color' => '', 'fontcolor'=> '', 'bordercolor'=>'', 'target'=>'', 'dropdown' =>'', 'state'=>''), $atts));

        $classes = "";

        $background =   'background:'.$color;
        
        $border = 'border-color:'.$bordercolor.' !important;';
