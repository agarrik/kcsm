                                                    ...
                                                    <div class="center-bar v1">
                                                        ...
                                                        <?php if($portfolio_style == 'v1'){ ?>
                                                            <div class="portfolio_go a0 " data-animate="zoomIn" >
                                                                <a data-animate="fadeInUp" class="lightbox-gallery lightbox" href="<?php echo esc_url(themeple_image_by_id(get_post_thumbnail_id(), '', 'url')) ?>"><?php  _e('View', 'themeple'); ?></a>
                                                            </div>  
                                                             <?php } ?>  
                                                        </div>    
                                                        <a href="<?php echo esc_url(get_permalink()) ?>" class="title a1 " data-animate="fadeInUp"><?php echo get_the_title() ?></a>
