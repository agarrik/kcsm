...
<div id="comments" class="header">
                        ...
                        <div class="single_title"><h3><?php echo $count.'&nbsp;'. __('Comments' ,'themeple'); ?></h3></div>
...
<?php comment_form(array('title_reply' => '<span>' .__('Leave a Reply', 'themeple'). '</span> '), $post->ID ) ?>
        ...
        ?>
                ...
                <div class="comment <?php if($depth == 1) echo 'span12'; else echo 'span11 offset1'; ?>">
                            ...
                            <dl class="dl-horizontal">
                                ...
                                <dd>
					               <div class="upper">
                                        <span class="author"><?php echo __('Posted by', 'themeple'); ?>&nbsp;<a href=""><?php echo get_comment_author_link($comment) ?></a>  <?php echo __('on', 'themeple'); ?>  </span>
                                        <ul>
