  ...
  <style type="text/css">
    ...
    nav .menu li > ul.sub-menu.non_mega_menu li:hover, nav .menu .sub-menu.non_mega_menu li.current-menu-item {background: <?php echo esc_attr(themeple_get_option('sub_background_hover_color')); ?>}
      nav .menu li > ul.sub-menu li:hover, nav .menu .sub-menu li .sub-menu li.current-menu-item{background: <?php echo esc_attr(themeple_get_option('sub_background_hover_color')); ?>}
    ...
    header#header.fixed_header, .header_4 .fixed_header #navigation, .fixed_header .right_search_container input[type="text"]{background:rgba(<?php echo esc_attr($header_bg_color['r']) ?>,<?php echo esc_attr($header_bg_color['g']) ?>,<?php echo esc_attr($header_bg_color['b']) ?>,1)}
  ...
  <?php if($header_logo_light_activation == 'yes'): ?>
   ...
   <?php endif; ?> 			
    ...
    .background--dark header#header.sticky_header.fixed_header .right_search_container input[type="text"], .background--dark header#header.sticky_header.fixed_header .right_search_container .input-append i {color:<?php echo esc_attr($nav_font_color); ?>}   
    header#header.sticky_header.fixed_header nav .menu li > a{ color:<?php echo esc_attr($sticky_font_color);?> }
   ...
   .animated_counter .count_to:after, .services_small h4:after,.dark .dynamic_page_header .line_under .line_left{background: <?php echo esc_attr($base_color) ?>}
    footer .tabbable .nav-tabs > li > a {color:<?php echo esc_attr($footer_font_color) ?>;}
    #popular_widget dl {border-bottom:1px solid <?php echo esc_attr($footer_border_color) ?>; } 
    ...
    aside .tweet_list dt i, #popular_widget i, footer a.twitter-link, footer span a{color:<?php echo esc_attr($base_color); ?>}
    footer a:hover, #copyright .widget ul li a:hover,#copyright .widget ul li.current_page_item a{color:<?php echo esc_attr($second_color);?>}
    .footer_social_bar:before, .top_footer .title, footer .footer_social_icons li a:hover
  {background:<?php echo esc_attr($footer_twitter_bg_color)?>;}  
    ...
    .widget #wp-calendar a, #faq-filter ul li.active a, #faq-filter ul li a:hover, .portfolio_go a i, .portfolio-item.v2 .categories {color:<?php echo esc_attr($base_color); ?>;}
    .portfolio_go, .tp-button.btn-system.normal.outline:hover{background-color: <?php echo esc_attr($base_color); ?>;}
    .tp-button.btn-system.normal.outline:hover, .tp-button.btn-system.normal{border:2px solid <?php echo esc_attr($base_color) ?>;} 
    .recent_portfolio a.categories.a2{color:<?php echo esc_attr($base_color); ?>; }
    ...
    nav .menu > li > ul.sub-menu, nav .menu > li > ul.sub-menu ul, nav .themeple_custom_menu_mega_menu, nav .menu li > ul.sub-menu li{background: <?php echo esc_attr(themeple_get_option('sub_background_color')); ?>}
nav .menu > li > ul.sub-menu, nav .menu > li > ul.sub-menu ul{
    border: solid 1px <?php echo esc_attr(themeple_get_option('sub_background_color')); ?>;
  }
    ...
    .header_border_left, .header_border_right, .border_counter_center, .map-button .header {background:<?php echo esc_attr($base_color) ?>;}
    ...
    .dark .animated_counter .icons i{color: <?php echo esc_attr($base_color); ?>;}
    ...
    .chart_skill .text .percent_color, .block_skill  span {color: <?php echo esc_attr($base_color); ?>;}
    ...
    .p_pagination .pagi ul li a, .p_pagination .nav-previous a, .p_pagination .nav-next a {border:1px solid <?php echo esc_attr($base_color) ?>; color:<?php echo esc_attr($base_color) ?>;}
    .p_pagination .pagi ul li.selected a, .p_pagination .pagi ul li a:hover, .p_pagination .nav-next a:hover, .p_pagination .nav-previous a:hover {background:<?php echo esc_attr($base_color)?>; border:1px solid <?php echo esc_attr($base_color) ?>;}
    ...
    .services_boxed .icon_wrapper {background: <?php echo esc_attr($base_color); ?>;}
    #blogmasonry .readm:hover, .load_more_pagination .load_new, .quote_box{background:<?php echo esc_attr($base_color); ?>}
    ...
    .tabbable .nav-tabs li.active{background: <?php echo esc_attr($base_color) ?>;}
    ...
    .header_wrapper.no-transparent{background: <?php echo esc_attr($header_background); ?>}
    .services_small_icon{border:2px solid <?php echo esc_attr($base_color) ?>;}
    ...
    .latest_blog .overlay li, .blog-article .date {color: <?php echo esc_attr($base_color); ?>}
    ...
    /*Animated Counters*/
    .light .animated_counter .icons i{ color: <?php echo esc_attr($base_color); ?>;}
     /* Border */
     ...
     <?php endif; ?>
     aside .tagcloud a{border:1px solid <?php echo esc_attr($base_border); ?>}    
     ...
     .textbar-container ={border:1px solid <?php echo esc_attr($base_color) ?>;}
    ...
    .line_under .line_right, .line_under_full .line_full:after{background: <?php echo esc_attr($base_border); ?>}
    ...
    .one-staff:hover .social_widget{border-bottom: 2px solid <?php echo esc_attr($base_color); ?>;}
    .one-staff .position_title:after, .one-staff .social_widget ul li:hover, .contact_info .social ul li:hover, .header_3 .footer_social_icons li:hover{background-color:  <?php echo esc_attr($base_color); ?>;}
    ...
    .light .services_boxed .icon_wrapper  {border:1px solid <?php echo esc_attr($base_color); ?>} 
      .single_testimonial h5{color: <?php echo esc_attr($base_color); ?>}
    .recent_news .tags, .latest_blog .tags i, .services_media .read_more a, .recent_news .news-carousel-item dl dd .read_right a{color:<?php echo esc_attr($base_color) ?>;}
    ...
    .services_medium .icon_wrapper{background:<?php echo esc_attr($base_color); ?>} 
    ...
    #content.masonry{background: <?php echo esc_attr($blog_masonry_bg) ?> !important;}
   .controls a, .recent_portfolio.pagination a, .recent_news .pagination a {border:1px solid <?php echo esc_attr($base_border); ?>;}
    ...
    /* End Border #e6e9ea */
    #portfolio-filter ul li.active,#portfolio-filter ul li:hover{background:<?php echo esc_attr($base_color) ?>; }
    ...
    nav .menu > li.current-menu-item a, nav .menu > li:hover a, nav .menu > li.current-menu-parent a,  nav .menu > li.current_page_ancestor a, nav .menu > li.current-menu-ancestor a, nav .menu>li.current-menu-item:after,nav .menu > li:hover:after, nav .menu > li.current-menu-parent:after, .fullwidth_slider_page .header_1.transparent nav .menu li.current-menu-item > a {color: <?php echo esc_attr($base_color) ?>;}
