...
$elements[] =	array(
					"type" 			=> "input_text", 
					"id" 			=> "page_hader_description", 
					"std"			=> "",
                    "name"          => __("Description", 'themeple'),
					"slug"			=> "page_header", 
					"required"      => array('page_header_style', 'centered')
...
$elements[] = 	array(
	                "type" 		    => "colorpicker", 
					"id" 			=> "page_header_title_font_color", 
					"std"			=> "#ffffff",
                    "name"          => __("Select the title font color", 'themeple'),
                    "required"      => array('page_header_style', 'centered'),
					"slug"			=> "page_header");
...
$elements[] = 	array(
					...
					"std"			=> "no",
                    "name"          => __("Turn on parallax effect", 'themeple'),
                    "required"      => array('page_header_style', 'centered'),
					"slug"			=> "page_header");
...
$elements[] = 	array(
					...
					"std"			=> "#fff",
                    "name"          => __("Select the basic font color", 'themeple'),
...
$elements[] = 	array(
	                "type" 		    => "colorpicker", 
					"id" 			=> "page_header_centered_overlay_bg_color", 
					"std"			=> "rgba(0, 0, 0, 0)",
                    "name"          => __("Select the overlay background color", 'themeple'),
					"slug"			=> "page_header");
...
$elements[] = 	array(
					...
					"std"			=> "#fff",
                    "name"          => __("Select the main font color", 'themeple'),
                    "required"      => array('page_header_style', 'left'),
					"slug"			=> "page_header");
