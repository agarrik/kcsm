                            ...
                            $lim = 13;
                              ...
                              $output .= '<div class="social_widget">'; 
                                ...
                                if(themeple_post_meta(get_the_ID(), 'twitter_link') != '')
                                    $output .= '<li class="twitter"><a href="'.themeple_post_meta(get_the_ID(), 'twitter_link').'" title="Twitterk"><i class="moon-twitter"></i></a></li>';
                                ...
                                if(themeple_post_meta(get_the_ID(), 'linkedin_link') != '')
                                    $output .= '<li class="linkedin"><a href="'.themeple_post_meta(get_the_ID(), 'linkedin_link').'" title="Likedin"><i class="moon-linkedin"></i></a></li>';
                                if(themeple_post_meta(get_the_ID(), 'mail_link') != '')
                                    $output .= '<li class="main"><a href="mailto:'.themeple_post_meta(get_the_ID(), 'mail_link').'" title="Mail"><i class="moon-mail"></i></a></li>';
