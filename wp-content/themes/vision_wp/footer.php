	    	...
	    	<div class="container">
	        	<div class="row-fluid">
		        	<div class="span12 desc">
                        ...
                        <div class="span6"><?php if (function_exists('dynamic_sidebar') && dynamic_sidebar('Copyright Footer Sidebar Right') ) : else : echo "<div class='widget'>Add Widget Column</div>"; endif; ?></div>
